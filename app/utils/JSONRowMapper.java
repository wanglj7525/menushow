...
/**
 * @ClassName: JSONRowMapper
 * @Description: 把jdbc查询结果封装成Map形式的JSON对象
 * @author wlj
 * @date 2014-7-31 上午10:40:56
 *
 */ 
public class JSONRowMapper implements SqlRowMapper<Map> {
